...
<template>
  ...
  <div class="form">
    <div class="form__item">
      <label class="form__item__label" for="">Estado</label>
      <select class="form__item__select" name="state" id="state" v-model="selectedState">
        <option value="-" selected="true" disabled>Selecciona un estado</option>
    ...
    <div class="form__item">
      <label class="form__item__label" for="">Municipio</label>
      <select class="form__item__select" name="municipio" id="municipio" v-model="selectedMunicipio">
        <option value="-" selected="true" disabled>Selecciona un municipio</option>
        <option
          v-for="municipio in selectedState.municipios"
          :value="municipio"
          :key="municipio.id"
        >
          {{ municipio }}
  ...
  <div class="results">
    <p>Estado seleccionado: {{ selectedState.estado }}</p>
    <p>Municipio seleccionado: {{ selectedMunicipio }}</p>
  </div>
</template>
